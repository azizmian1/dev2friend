    ...
    <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <form method="POST" action="<?php echo base_url(); ?>Members/addMember" data-parsley-validate>
                ...
                <!-- Password -->
                <div class="az-content-label mg-b-5">Password</div>

                <div class="row row-sm mg-t-20">
                    <div class="col-lg">
                        <textarea name ="user_pass" rows="3" class="form-control" placeholder="Enter Password"></textarea>
                    </div><!-- col -->
                </div><!-- row -->
                ...
                <div class="row row-sm mg-t-20 wd-300">
                    <div id="genderWrapper" class="parsley-select col-lg">
                        <select name="active_stat_flg" class="form-control select2-no-search" data-parsley-class-handler="#genderWrapper" data-parsley-errors-container="#genderErrorContainer" required>
                ...
                <div class="row row-sm mg-t-20 wd-300">
                    <div id="genderWrapper" class="parsley-select col-lg">
                        <select name="access_role_flg" class="form-control select2-no-search" data-parsley-class-handler="#genderWrapper" data-parsley-errors-container="#genderErrorContainer" required>
                            <option label="Choose one"></option>
