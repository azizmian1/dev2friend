        ...
        <div class="az-content-body az-content-body-contacts">
            <div class="az-contact-info-header">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4>
                            ...
                            <?php echo $selectedMember->LAST_NAME . ', ' . $selectedMember->FIRST_NAME ?></h4>
                        <nav class="nav">
                ...
                <div class="az-contact-action">
                    <a href="<?php echo base_url(); ?>Members/Edit/<?php echo $selectedMember->MEMBER_ID; ?>"><i class="typcn typcn-edit"></i> Edit Member</a>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div>
                                ...
                                <span class="tx-medium"><?php echo $selectedMember->EMAIL ?></span>
                            </div>
                        </div><!-- media-body -->
                    </div><!-- media -->
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div>
                                ...
                                <?php 
                                if($selectedMember->ACTIVE_STAT_FLG == 'A') {
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-indigo" onclick="location.href = '<?php echo base_url(); ?>Members/Delete/<?php echo $selectedMember->MEMBER_ID; ?>'">Save changes</button>
...
<div id="resendqrmodal" class="modal">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to resend the QR Code to <?php echo $selectedMember->EMAIL ?>? </p>
            </div>
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-indigo" onclick="location.href = '<?php echo base_url(); ?>Members/Resend/<?php echo $selectedMember->MEMBER_ID ?>'">Proceed</button>
                <button type="button" class="btn btn-outline-light" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div><!-- modal-dialog -->
...
<div id="addtoprojectmodal" class="modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <form method="POST" action="<?php echo base_url(); ?>Members/addToProject/<?php echo $selectedMember->MEMBER_ID; ?>" data-parsley-validate>
            <div class="modal-header">
            ...
            <div class="modal-body">
                <h6>Which project would you like to add  <?php echo $selectedMember->FIRST_NAME . " " . $selectedMember->LAST_NAME ?>?</h6>
                
                <!-- Form to add a member to the project selected -->
                <div>
                    <select name="projects[]" class="form-control wd-350 mg-b-20 select2" multiple="multiple">
                    <?php
                    ...
                    foreach ($projects as $project):
                        if (in_array($project->PROJECT_ID, $array)) {
                            echo '<option value="' . $project->PROJECT_ID . '" selected>' . $project->ABBREVIATION. '</option>';
                        }
                        else {
                            echo '<option value="' . $project->PROJECT_ID . '">' . $project->ABBREVIATION. '</option>';
                        }
                    endforeach; ?>
                    </select>
                </div><!-- col -->
